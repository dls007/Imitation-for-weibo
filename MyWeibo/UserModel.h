...
@interface UserModel : MyBaseModel

@property(nonatomic,copy)NSString *idstr;               //字符串型的UID
...
@property(nonatomic,copy)NSString *url;                 //用户微博地址
@property(nonatomic,copy)NSString *profile_image_url;   //小头像
...
@property(nonatomic,copy)NSNumber *verified;            //是否支持微博
