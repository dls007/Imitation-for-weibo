...
- (id)initWithJsonDictionary:(NSDictionary*)dic
{
    ...
    if (self) {
        ...
        self.bmiddleImageUrl = [dic stringValueForKey:@"bmiddle_pic"];
...
- (void)encodeWithCoder:(NSCoder *)encoder
{
    ...
    [encoder encodeObject:self.bmiddleImageUrl forKey:@"bmiddleImageUrl"];
}
...
- (id)initWithCoder:(NSCoder *)decoder
{
    ...
    if (self) {
        ...
        self.thumbnailImageUrl = [decoder decodeObjectForKey:@"bmiddleImageUrl"];
    }
    return self;
}
